...
def se_resnet18(num_classes=1000):
    ...
    """
    model = ResNet.ResNet(SEBasicBlock, [2, 2, 2, 2], num_classes=num_classes)
...
def se_resnet34(num_classes=1000):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet.ResNet(SEBasicBlock, [3, 4, 6, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def se_resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet.ResNet(SEBottleneck, [3, 4, 6, 3], **kwargs)
    #model.avgpool = nn.AdaptiveAvgPool2d(1)
    if pretrained:
...
def se_resnet101(num_classes=1000):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet.ResNet(SEBottleneck, [3, 4, 23, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def se_resnet152(num_classes=1000):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet.ResNet(SEBottleneck, [3, 8, 36, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
